            ...
            switch (opcao) {
                ...
                case 9:
                    while (!sair2) {
                        ...
                        System.out.println("3 - VER A PESSOA FÍSICA PELO ID");
                        System.out.println("4 - DELETAR UMA PESSOA FÍSICA PELO ID");
                        System.out.println("5 - ATUALIZAR DADOS DE UMA PESSOA FÍSICA PELO ID");
                        System.out.println("6 - RETORNAR");
                ...
                case 10:
                    while (!sair2) {
                        ...
                        System.out.println("3 - VER A PESSOA JURÍDICA PELO ID");
                        System.out.println("4 - DELETAR UMA PESSOA JURÍDICA PELO ID");
                        System.out.println("5 - ATUALIZAR DADOS DE UMA PESSOA JURÍDICA PELO ID");
                        System.out.println("6 - RETORNAR");
